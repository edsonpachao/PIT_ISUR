...
function get_people_manage_table($people,$controller)
{
	...
	$CI->lang->line('common_dni'),
	$CI->lang->line('common_first_name'),
	$CI->lang->line('common_last_name'),
	$CI->lang->line('common_ruc'),	
	$CI->lang->line('common_razonsocial'),
...
function get_person_data_row($person,$controller)
{
	...
	$table_data_row.='<td width="4%">'.character_limiter($person->dni,13).'</td>';
	$table_data_row.='<td width="8%">'.character_limiter($person->first_name,13).'</td>';
	$table_data_row.='<td width="8%">'.character_limiter($person->last_name,13).'</td>';
	$table_data_row.='<td width="5%">'.character_limiter($person->ruc,13).'</td>';		
	$table_data_row.='<td width="15%">'.character_limiter($person->company_name,13).'</td>';
	$table_data_row.='<td width="5%">'.character_limiter($person->phone_number,13).'</td>';	
	$table_data_row.='<td width="20%">'.mailto($person->email,character_limiter($person->email,22)).'</td>';
			
	$table_data_row.='<td width="2%">'.anchor($controller_name."/view/$person->person_id/width:$width", $CI->lang->line('common_edit'),array('class'=>'thickbox','title'=>$CI->lang->line($controller_name.'_update'))).'</td>';		
	$table_data_row.='</tr>';
