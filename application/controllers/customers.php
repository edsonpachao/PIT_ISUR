...
class Customers extends Person_controller
{
	...
	*/
	function save($customer_id=-1)
	{
		...
		'tpcustomer'=>$this->input->post('tpcustomer'),
	...
	function check_dni()
	{
		$exists = $this->Customer->dni_exists($this->input->post('dni'),$this->input->post('person_id'));
		echo json_encode(array('success'=>!$exists,'message'=>$this->lang->line('customers_dni_duplicate')));
	}

	function check_ruc()
	{
		$exists = $this->Customer->ruc_exists($this->input->post('ruc'),$this->input->post('person_id'));
		echo json_encode(array('success'=>!$exists,'message'=>$this->lang->line('customers_ruc_duplicate')));
	}
